...
class CreateCourseFormComponent(BaseComponent):
    ...
    @allure.step('Fill create form "{title}", "{description}", "{estimated_time}", "{max_score}", "{min_score}"')
    def fill(
            self,
            title: str,
            estimated_time: str,
    ...
    @allure.step('check visible create form course with information "{title}", "{description}", "{estimated_time}", "{max_score}", "{min_score}"')
    def check_visible(
            self,
            title: str,
            estimated_time: str,
